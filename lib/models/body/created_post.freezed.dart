...
mixin _$NewCreatedPost {
  ...
  bool get wholeDay => throw _privateConstructorUsedError;
  ...
  List<AttachmentForCreatedPost> get attachments =>
      throw _privateConstructorUsedError;
  bool get notificationsActive => throw _privateConstructorUsedError;
  String get notificationsUnit => throw _privateConstructorUsedError;
...
class _$NewCreatedPostCopyWithImpl<$Res, $Val extends NewCreatedPost>
  ...
  $Res call({
    ...
    Object? notificationsActive = null,
    Object? notificationsUnit = null,
    ...
    return _then(_value.copyWith(
      ...
      notificationsActive: null == notificationsActive
          ? _value.notificationsActive
          : notificationsActive // ignore: cast_nullable_to_non_nullable
              as bool,
      notificationsUnit: null == notificationsUnit
          ? _value.notificationsUnit
          : notificationsUnit // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$NewCreatedPostImpl
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'NewCreatedPost(title: $title, description: $description, categoryKey: $categoryKey, contacts: $contacts, businessPartners: $businessPartners, latitude: $latitude, longitude: $longitude, address: $address, important: $important, canceled: $canceled, uncertain: $uncertain, sensitiveInfo: $sensitiveInfo, type: $type, visualization: $visualization, rating: $rating, from: $from, to: $to, interval: $interval, date: $date, at: $at, within: $within, morning: $morning, afternoon: $afternoon, evening: $evening, wholeDay: $wholeDay, singlePartyTransactions: $singlePartyTransactions, multiPartyTransaction: $multiPartyTransaction, attachments: $attachments, notificationsActive: $notificationsActive, notificationsUnit: $notificationsUnit, businessPartnerBranch: $businessPartnerBranch)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('within', within))
      ..add(DiagnosticsProperty('morning', morning))
      ..add(DiagnosticsProperty('afternoon', afternoon))
      ..add(DiagnosticsProperty('evening', evening))
      ...
      ..add(DiagnosticsProperty('notificationsActive', notificationsActive))
      ..add(DiagnosticsProperty('notificationsUnit', notificationsUnit))
      ..add(
          DiagnosticsProperty('businessPartnerBranch', businessPartnerBranch));
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.notificationsActive, notificationsActive) ||
                other.notificationsActive == notificationsActive) &&
            (identical(other.notificationsUnit, notificationsUnit) ||
                other.notificationsUnit == notificationsUnit) &&
...
abstract class _NewCreatedPost implements NewCreatedPost {
  const factory _NewCreatedPost(
      ...
      final List<SinglePartyTransactionForCreatedPost>? singlePartyTransactions,
      final MultiPartyTransactionForCreatedPost? multiPartyTransaction,
      final List<AttachmentForCreatedPost> attachments,
      final bool notificationsActive,
      final String notificationsUnit,
      final String businessPartnerBranch}) = _$NewCreatedPostImpl;
